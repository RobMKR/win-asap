    ...
    <section class="content">
        <div class="container-lg whiteBg">
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-12 col-md-12 mt-35">
                    <div class="flex md">
                        <div class="col-lg-5 col-md-12 flex align-center justify-center">
                            <img src="assets/images/Range-Rover-Evoque.png" width="100%" style="max-width: 450px" alt="">
                        </div>
                        <div class="col-lg-7 col-md-12 xs-padd">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-15 xs-padd-15" style="margin: 25px auto;padding: 0 60px;">
                            <div class="row">
                                <div class="col-md-12 text-center">
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 text-center margin-center">
                    <h4>ՄԱՍՆԱԿՑՈՒԹՅԱՆ ԿԱՐԳԻՆ ԵՎ ՄԻՋՈՑԱՌՄԱՆ ԿԱՆՈՆՆԵՐԻՆ ԾԱՆՈԹԱՆԱԼՈՒ ՀԱՄԱՐ ԱՆՀՐԱԺԵՇՏ Է ԳՐԱՆՑՎԵԼ</h4>
